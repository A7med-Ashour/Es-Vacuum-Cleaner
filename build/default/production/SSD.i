...
static tSSD_INFO ssd_data[(3)];
static tSSD current_ssd = SSD_LOW;


static tByte ssd_decoder[(11)] = {0X3F,0X06,0X5B,0X4F,0X66,0X6D,0X7D,0X07,0X7F,0X6F,0X00};
...
void SSD_init(tSSD ssd){
    ...
    ((*(ssd_data[ssd].data_direction_reg)) = ((((0))) ? (~(0)) : ((0))));


    SSD_display(ssd , 0x00);


    ((*(ssd_data[ssd].ctrl_direction_reg)) = ((*(ssd_data[ssd].ctrl_direction_reg) & (~(1 << ssd_data[ssd].ctrl_pin))) | (((0)) << ssd_data[ssd].ctrl_pin)));
    (((*(ssd_data[ssd].ctrl_value_reg)) = ((*(ssd_data[ssd].ctrl_value_reg) & (~(1 << ssd_data[ssd].ctrl_pin))) | (((0)) << ssd_data[ssd].ctrl_pin))));
...
void SSD_update(void){
    ...
    ssd_update_counter += (10);

    if (ssd_update_counter == (10)){
        ...
        for(index = SSD_LOW; index < (3); index++){
            SSD_off(index);
        }
...
static void SSD_schematic_init(void){
     ...
     ssd_data[0] = (tSSD_INFO){&(((*((volatile tRegister *)(0x88))).Reg)),&(((*((volatile tRegister *)(0x08))).Reg)),&(((*((volatile tRegister *)(0x86))).Reg)),&(((*((volatile tRegister *)(0x06))).Reg)),((6)),0x00,SSD_NULL};
     ssd_data[1] = (tSSD_INFO){&(((*((volatile tRegister *)(0x88))).Reg)),&(((*((volatile tRegister *)(0x08))).Reg)),&(((*((volatile tRegister *)(0x86))).Reg)),&(((*((volatile tRegister *)(0x06))).Reg)),((5)),0x00,SSD_NULL};
     ssd_data[2] = (tSSD_INFO){&(((*((volatile tRegister *)(0x88))).Reg)),&(((*((volatile tRegister *)(0x08))).Reg)),&(((*((volatile tRegister *)(0x86))).Reg)),&(((*((volatile tRegister *)(0x06))).Reg)),((4)),0x00,SSD_NULL};
...
void SSD_display(tSSD ssd , tByte data){
    ((*(ssd_data[ssd].data_value_reg)) = (data));
}


static void SSD_on (tSSD ssd){
    (((*(ssd_data[ssd].ctrl_value_reg)) = ((*(ssd_data[ssd].ctrl_value_reg) & (~(1 << ssd_data[ssd].ctrl_pin))) | (((1)) << ssd_data[ssd].ctrl_pin))));
}
