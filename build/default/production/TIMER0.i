...
void timer0_init(tTMR0_Prescaller p,tTMR0_Mode m, tTMR0_OVF_State o){
    ...
    T0_OneCountTime = (tWord) round((T0_PreScaller) / 2.0);

}

void timer0_reload(TMR0_SIZE val){

    ((*((volatile tRegister *)(0x01))).Reg) = val;
}
TMR0_SIZE TMR0_getValue(void){

    return ((*((volatile tRegister *)(0x01))).Reg);
}
void T0_timer_mode_state(tTMR0_State s){

    switch(s) {
        case T0_ON :
            (((*((volatile tRegister *)(0x81))).Bits.BIT5) = 0);
            break;
        case T0_OFF :
            (((*((volatile tRegister *)(0x81))).Bits.BIT5) = 1);
            break;
        default:
...
static void timer0_set_prescaller(tTMR0_Prescaller p){
    ...
    switch(p){
        case T0_PRESCALLER_2:
            ((*((volatile tRegister *)(0x81))).Bits.BIT3) = (0); ((*((volatile tRegister *)(0x81))).Bits.BIT0) = 0; ((*((volatile tRegister *)(0x81))).Bits.BIT1) = 0; ((*((volatile tRegister *)(0x81))).Bits.BIT2) = 0;
            T0_PreScaller = 2;
            break;
        case T0_PRESCALLER_4:
            ((*((volatile tRegister *)(0x81))).Bits.BIT3) = (0); ((*((volatile tRegister *)(0x81))).Bits.BIT0) = 1; ((*((volatile tRegister *)(0x81))).Bits.BIT1) = 0; ((*((volatile tRegister *)(0x81))).Bits.BIT2) = 0;
            T0_PreScaller = 4;
            break;
        case T0_PRESCALLER_8:
            ((*((volatile tRegister *)(0x81))).Bits.BIT3) = (0); ((*((volatile tRegister *)(0x81))).Bits.BIT0) = 0; ((*((volatile tRegister *)(0x81))).Bits.BIT1) = 1; ((*((volatile tRegister *)(0x81))).Bits.BIT2) = 0;
            T0_PreScaller = 8;
            break;
        case T0_PRESCALLER_16:
            ((*((volatile tRegister *)(0x81))).Bits.BIT3) = (0); ((*((volatile tRegister *)(0x81))).Bits.BIT0) = 1; ((*((volatile tRegister *)(0x81))).Bits.BIT1) = 1; ((*((volatile tRegister *)(0x81))).Bits.BIT2) = 0;
            T0_PreScaller = 16;
            break;
        case T0_PRESCALLER_32:
            ((*((volatile tRegister *)(0x81))).Bits.BIT3) = (0); ((*((volatile tRegister *)(0x81))).Bits.BIT0) = 0; ((*((volatile tRegister *)(0x81))).Bits.BIT1) = 0; ((*((volatile tRegister *)(0x81))).Bits.BIT2) = 1;
            T0_PreScaller = 32;
            break;
        case T0_PRESCALLER_64:
            ((*((volatile tRegister *)(0x81))).Bits.BIT3) = (0); ((*((volatile tRegister *)(0x81))).Bits.BIT0) = 1; ((*((volatile tRegister *)(0x81))).Bits.BIT1) = 0; ((*((volatile tRegister *)(0x81))).Bits.BIT2) = 1;
            T0_PreScaller = 64;
            break;
        case T0_PRESCALLER_128:
            ((*((volatile tRegister *)(0x81))).Bits.BIT3) = (0); ((*((volatile tRegister *)(0x81))).Bits.BIT0) = 0; ((*((volatile tRegister *)(0x81))).Bits.BIT1) = 1; ((*((volatile tRegister *)(0x81))).Bits.BIT2) = 1;
            T0_PreScaller = 128;
            break;
        case T0_PRESCALLER_256:
            ((*((volatile tRegister *)(0x81))).Bits.BIT3) = (0); ((*((volatile tRegister *)(0x81))).Bits.BIT0) = 1; ((*((volatile tRegister *)(0x81))).Bits.BIT1) = 1; ((*((volatile tRegister *)(0x81))).Bits.BIT2) = 1;
            T0_PreScaller = 256;
            break;
        default :
...
static void timer0_ovf_setState(tTMR0_OVF_State o ){
    switch(o){
        case T0_OVF_ENABLE :
            ((*((volatile tRegister *)(0x0B))).Bits.BIT7 = 1);
            (((*((volatile tRegister *)(0x0B))).Bits.BIT5) = 1);
            break;
        case T0_OVF_DISABLE :
            (((*((volatile tRegister *)(0x0B))).Bits.BIT5) = 0);
            break;
        default :
