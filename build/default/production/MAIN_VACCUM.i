...
# 18 "MAIN_VACCUM.c" 2
# 27 "MAIN_VACCUM.c"
static tByte Schedular_State = (0);
...
static void INDICATOR_init(void) {
    ...
    ((((((*((volatile tRegister *)(0x87))).Reg))) = (((((*((volatile tRegister *)(0x87))).Reg)) & (~(1 << ((1))))) | (((0)) << ((1))))));
    ((((((*((volatile tRegister *)(0x07))).Reg))) = (((((*((volatile tRegister *)(0x07))).Reg)) & (~(1 << ((1))))) | ((0) << ((1))))));
}
...
void __attribute__((picinterrupt(("high_priority")))) OS_ISR(void){


    if((((*((volatile tRegister *)(0x0B))).Bits.BIT2))){

       (((((((*((volatile tRegister *)(0x07))).Reg))) = (((((*((volatile tRegister *)(0x07))).Reg)) & (~(1 << ((1))))) | (!(((((*((volatile tRegister *)(0x07))).Reg)) >> ((1))) & (1)) << ((1)))))));
        timer0_reload((99));
        (((*((volatile tRegister *)(0x0B))).Bits.BIT2)) = (0);
        Schedular_State = (1);
    }

    if(((*((volatile tRegister *)(0x0C))).Bits.BIT0)){
       MO_fire();
       ((*((volatile tRegister *)(0x0C))).Bits.BIT0) = (0);
    }
