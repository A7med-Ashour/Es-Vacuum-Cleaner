...
static tWord MO_AngelVal[(4)] = {140,90,10,170};
...
void MO_init(void){
    ...
    ((((((*((volatile tRegister *)(0x87))).Reg))) = (((((*((volatile tRegister *)(0x87))).Reg)) & (~(1 << ((2))))) | (((0)) << ((2))))));

    ((((((*((volatile tRegister *)(0x07))).Reg))) = (((((*((volatile tRegister *)(0x07))).Reg)) & (~(1 << ((2))))) | ((0) << ((2))))));



    MO_targetAngel = MO_AngelVal[(3)];
    MO_currentAngel = MO_AngelVal[(3)];
...
void MO_getTargetAngel(tMoAngel * pAngel){
    ...
    for(tMoAngel angel = 0; angel < (4); angel++){
...
void MO_fire(void){
# 109 "MOTOR.c"
    ((((((*((volatile tRegister *)(0x07))).Reg))) = (((((*((volatile tRegister *)(0x07))).Reg)) & (~(1 << ((2))))) | ((1) << ((2))))));
...
# 152 "MOTOR.c"
    ...
    TMR1_reload((65535) - (MO_currentAngel * MO_SingleAngelTime));
...
static void MO_reduceHARM(void){
    ...
    static tByte RH_counter = (0);
    static tByte RH_flag = (1);
    ...
    if( MO_isStable ){
        ...
        if(RH_flag == (0)){
            ...
            MO_currentAngel = MO_targetAngel + (5);
