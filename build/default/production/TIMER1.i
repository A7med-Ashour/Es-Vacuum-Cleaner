...
void TMR1_init(TMR1_Prescaller p , TMR1_Mode m , TMR1_OVF_State s){
    ...
    switch(p){
        ...
        case TMR1_PRS_1 :
            ((*((volatile tRegister *)(0x10))).Reg = (*((volatile tRegister *)(0x10))).Reg & 0x0F);
            break;

        case TMR1_PRS_2 :
            ((*((volatile tRegister *)(0x10))).Reg = ((*((volatile tRegister *)(0x10))).Reg & 0x0F) | (1 << 4));
            break;

        case TMR1_PRS_4:
            ((*((volatile tRegister *)(0x10))).Reg = ((*((volatile tRegister *)(0x10))).Reg & 0x0F) | (2 << 4));
            break;

        case TMR1_PRS_8 :
            ((*((volatile tRegister *)(0x10))).Reg = ((*((volatile tRegister *)(0x10))).Reg & 0x0F) | (3 << 4));
            break;
    ...
    switch(m) {
        ...
        case TMR1_TMR_MODE :
            ((*((volatile tRegister *)(0x10))).Bits.BIT1 = 0);
            break;

        case TMR1_CNT_MODE :
            ((*((volatile tRegister *)(0x10))).Bits.BIT1 = 1);
            break;
    ...
    switch(s) {
        case TMR1_OVF_EN :
            ...
            ((*((volatile tRegister *)(0x0B))).Bits.BIT6 = 1);
            (TMR1IE = 1);
            break;
...
void TMR1_reload(TMR1_SIZE val) {
    ...
    (*((volatile tRegister *)(0x0E))).Reg = val;
    (*((volatile tRegister *)(0x0F))).Reg = val >> 8;
...
void TMR1_getVal(TMR1_SIZE * pval){
    ...
    *pval = (((tWord)((*((volatile tRegister *)(0x0F))).Reg)) << 8) | ((*((volatile tRegister *)(0x0E))).Reg);
}
...
void TMR1_setState(TMR1_State s){
    ...
    switch(s) {
        ...
        case TMR1_ON_STATE:
            ((*((volatile tRegister *)(0x10))).Bits.BIT0 = 1);
            break;

        case TMR1_OFF_STATE :
            ((*((volatile tRegister *)(0x10))).Bits.BIT0 = 0);
            break;
